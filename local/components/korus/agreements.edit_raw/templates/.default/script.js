      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, row) {
            ...
            if (additionProductsRaw[storeId] && additionProductsRaw[storeId][data]) {
              $.each(additionProductsRaw[storeId][data], function(index, value) {
                var html = "<span class='price-piece'>" + $.number(getDefaultPrice(value), 2, '.', ' ') + "</span> руб.";
                if (index == 0) {
                  divSource += html;
                } else {
        ...
        },
        {
          ...
          render: function (data, type, row) {
            ...
            if (additionProductsRaw[storeId] && additionProductsRaw[storeId][data]) {
              $.each(additionProductsRaw[storeId][data], function(index, value) {
                var html = "<span class='price-piece-nds'>" + $.number((getDefaultPrice(value) * ndsCoef), 2, '.', ' ') + "</span> руб.";
                if (index == 0) {
                  divSource += html;
                } else {
                  targetDiv += '<div class="js-div-copy price-fixed">' + html + '</div>';
        ...
        },
        {
          ...
          render: function (data, type, row) {
            ...
            if (additionProductsRaw[storeId] && additionProductsRaw[storeId][data]) {
              $.each(additionProductsRaw[storeId][data], function(index, value) {
                var html = "<span class='price-piece-total'>" + $.number((getDefaultPrice(value) * ndsCoef * value["VOLUME"]), 2, '.', ' ') + "</span> руб.";
                if (index == 0) {
                  divSource += html;
                } else {
                  targetDiv += '<div class="js-div-copy price-fixed">' + html + '</div>';
